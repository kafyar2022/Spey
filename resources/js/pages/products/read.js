const productPage = document.querySelector('[data-id="products-read-page"]');
if (productPage) {
    const infoSection = productPage.querySelector('[data-id="product-info"]'),
    ...
    const productSearchSection = productPage.querySelector('[data-id="product-search"]'),
